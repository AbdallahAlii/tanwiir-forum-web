...
const values = [
  ...
  },
  {
    icon: Eye,
    title: "Visionary",
    desc: "We look ahead to build systems and programs that prepare tomorrow's leaders today.",
  },
  {
    icon: Heart,
    title: "Inclusive",
    desc: "We welcome all backgrounds, fostering diversity and unity within our community.",
  },
  {
    icon: Users,
    title: "Collaborative",
    desc: "Partnerships with local and international organizations amplify our impact.",
  },
];
    ...
    <div>
        ...
        <div className="container-max px-4 sm:px-6 lg:px-8 relative">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              Tanwiir Forum is a community organization dedicated to building
              great leaders through impactful events, mentorship, and connecting
              influential speakers with aspiring changemakers.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              Founded with the belief that great communities are built by great
              leaders, Tanwiir Forum began as a small gathering of like-minded
              individuals passionate about creating positive change.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              Today, we've grown into a vibrant platform that hosts events,
              brings together students and professionals, and creates spaces
              where ideas flourish and leaders emerge.
            </p>
          </div>
          <img
            src={communityImg}
      ...
      <Section className="bg-card/50">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl sm:text-4xl font-display font-bold mt-2">
            Meet the People Behind Tanwiir
          </h2>
        </div>
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {team.map((t, i) => (
